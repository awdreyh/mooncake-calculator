...
final List<Map<String, dynamic>> recipesSeed = [

  {
    ...
    'name': 'recipe_cantonese_dough',
    'quantity': 8,
    'size': 100,
    'ratio': 0.4,
    'typeId': '7a91f6c1-4c5d-482e-a15a-7d9e7b3c0f89',
    'description': 'recipe_cantonese_dough_description',
    'ingredients': [
  ...
  },
  {
    ...
    'name': 'recipe_red_bean_filling',
    'quantity': 8,
    'size': 100,
    'ratio': 0.4,
    'typeId': 'f7a5d8b9-2c1f-4f3d-a8bd-2a4e7d5c9e1f',
    'description': 'recipe_red_bean_filling_description',
    'ingredients': [
      { 'id': 'c5f4e3d2-b1a0-4f9d-8e7c-6a5b4c3d2e01',  'name': 'red_bean_dry', 'amount': 168.0, 'unit': UnitType.g.name, 'category': IngredientCategory.recipe.name },
      { 'id': 'd7e6f5a4-b3c2-4d1e-9f8a-0b1c2d3e4f02',  'name': 'invert_syrup', 'amount': 33.0, 'unit': UnitType.g.name, 'category': IngredientCategory.recipe.name },
      { 'id': 'e8f7a6b5-c4d3-4e2f-9a0b-1c2d3e4f5a03',  'name': 'sugar', 'amount': 33.0, 'unit': UnitType.g.name, 'category': IngredientCategory.recipe.name },
      { 'id': 'f9a8b7c6-d5e4-4f3a-9b0c-1d2e3f4a5b04',  'name': 'vegetable_oil', 'amount': 33.0, 'unit': UnitType.g.name, 'category': IngredientCategory.recipe.name }
    ],
    'isFavorite': false,
    'rating': 0,
    'url': null,
  ...
  },
   {
    ...
    'name': 'recipe_lotus_seed_filling',
    'quantity': 8,
    'size': 100,
    'ratio': 0.4,
