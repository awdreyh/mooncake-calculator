...
class Recipe {
  ...
  static Future<Recipe> getRecipebyId(Database db, String? recipeId) async {
  ...
  static Future<String> getTypebyRecipeId(Database db, String? recipeId) async {
    if (recipeId == null || recipeId.isEmpty) {
      return '';
    }

    final recipe = await load(db, recipeId);
    return recipe?.typeId ?? '';
  }
