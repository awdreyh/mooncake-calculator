...
class EditDirectionPage extends StatefulWidget {
  ...
  const EditDirectionPage({super.key, required this.recipeId});

  @override
  State<EditDirectionPage> createState() => _EditDirectionPageState();
}
...
class _EditDirectionPageState extends State<EditDirectionPage> {
  ...
  final List<_DirectionInput> _directions = [];
    ...
    try {
      ...
      setState(() {
        ...
        if (directions.isEmpty) {
          _directions.add(_DirectionInput(stepIndex: 1));
        } else {
          for (int i = 0; i < directions.length; i++) {
            ...
            _directions.add(
              _DirectionInput(
                title: d.stepTitle,
                description: d.stepDescription,
                imagePath: d.stepImagePath,
                stepIndex: i + 1,
              ),
            );
          }
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(AppStrings.get('edit_directions', lang)),
          actions: [],
        ),
        body: _isLoading
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  OutlinedButton.icon(
                                    ...
                                    label: Text(
                                      AppStrings.get('selectImage', lang),
                                    ),
